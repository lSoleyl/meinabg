...
<form action="index.php?ACTION=buyshares" method=post>
  ...
  <input type="text" name="count" size=6 value="1" autofocus="autofocus"> '{{share_name}}' Aktien f&uuml;r {{share_price}}&euro;/Aktie <input type="submit" value="kaufen"> (Maximal {{max_shares}})<br>
